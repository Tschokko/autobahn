                                          ...
                                          struct openvpn_plugin_args_open_return *ret)
{
    ...
    std::error_code ec;
    auto [events, handle] = plugin::open(i_get_args(args->argv), i_get_env(args->envp), ec);
                                          ...
                                          struct openvpn_plugin_args_func_return *retptr)
{
    ...
    auto [result, string_map] = plugin::handle_event(
        static_cast<plugin_events>(args->type), i_get_args(args->argv), i_get_env(args->envp),
        reinterpret_cast<plugin::handle_t *>(args->handle), ec);
