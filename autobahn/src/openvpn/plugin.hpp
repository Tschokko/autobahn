...
template <class H> class plugin {
  public:
    ...
    static open_result_t open(arg_list_t const &args, env_map_t const &env, std::error_code &ec)
    {
    ...
    static event_result_t handle_event(plugin_events event, arg_list_t const &args,
                                       env_map_t const &env, handle_t *const &handle,
                                       std::error_code &ec)
    {
        switch (event) {
