...
#include "autobahn/src/openvpn/client_config.hpp"
#include "autobahn/src/openvpn/client_config_builder.hpp"
#include "boost/asio/ip/address_v4.hpp"
#include "boost/asio/ip/network_v4.hpp"
#include "gtest/gtest.h"

TEST(openvpn__client_config_builder,
     build_config_with_ipv4_route__has_push_ipv4_route) {
  // Arrange
  ...
  // Act
  auto actual = autobahn::openvpn::client_config_builder::build(config);
...
TEST(openvpn__client_config_builder,
     build_config_with_ipv6_route__has_push_ipv6_route) {
  // Arrange
...
TEST(openvpn__client_config_builder,
     build_config_with_ipv4_network__has_ipv4_iroute) {
  // Arrange
...
TEST(openvpn__client_config_builder,
     build_config_with_ipv6_network__has_ipv6_iroute) {
  // Arrange
